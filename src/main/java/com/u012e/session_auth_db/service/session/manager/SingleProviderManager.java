...
public class SingleProviderManager implements com.u012e.session_auth_db.service.session.manager.SessionManager {

    private final SessionProvider provider;

    /// Ordering matters, the first provider that can create a session will be used
    public SingleProviderManager(SessionProvider provider) {
